...
out_fp=${HDFS_PROJECT_PT}/data/fs/l1-15-adjacent-continue-visit_${t_wid}_${w_len}.txt
...
class=com.houjp.tianyi.classification.feature.L115AdjacentContinueVisit
